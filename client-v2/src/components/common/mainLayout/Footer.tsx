...
const Footer = () => {
    return (
        <footer id={cx("footer")}>
            <div className={`container ${cx("footer-wrapper")}`}>
                <div className="row">
                    <section className="col-3">
                        ...
                        <ul className={cx("list-group")}>
                            ...
                            <li>
                                0105848319 do sở KHĐT TP Hà Nội cấp ngày
                                09/04/2012
                            </li>
                            <li>Website:</li>
                    ...
                    {listGroups.map((listGroup, index) => (
                        <section className="col-3" key={index}>
                            <h3 className={cx("title-group")}>
                                {listGroup.titleGroup}
                            </h3>
                            <ul className={cx("list-group")}>
