      ...
      >
        ...
        <div className={cx("form__group")}>
          <div className={cx("form__group__input")}>
            <label>Họ:</label>
            <input name="lastname" required onChange={handleUserChange} />
          </div>
        </div>
        ...
        <div className={cx("form__group")}>
          <div className={cx("form__group__input")}>
            <label>Tên:</label>
            <input name="firstname" required onChange={handleUserChange} />
          </div>
        </div>
        ...
        <div className={cx("form__group")}>
          <div className={cx("form__group__input")}>
            ...
            <input name="password" required onChange={handleUserChange} />
          </div>
        </div>
        ...
        <div className={cx("form__signup")}>
          <p>
            Đã có tài khoản? <Link href="/auth/login">Đăng nhâp.</Link>
          </p>
        </div>
      </form>
      <ToastContainer />
