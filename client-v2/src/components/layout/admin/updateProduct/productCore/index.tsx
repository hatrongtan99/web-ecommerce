...
const ProductCore = <T extends FormikValuesType>({
  product,
  touched,
  errors,
  setFieldValue,
        ...
        <div className="d-flex">
          ...
          <input
            ...
            onChange={(e: ChangeEvent<HTMLInputElement>) =>
              hanldleSingleImage({ e, setFieldValue })
            }
          />
        </div>
        {touched.products && errors.products && (
          <div className="mt-1" style={{ color: "red", fontSize: "0.8rem" }}>
            {errors as string}
          </div>
        )}
      </div>
      ...
      <div className={cx("form-group")}>
        <div className="d-flex">
          ...
          <input
            ...
            className="form-control"
            onChange={(e: ChangeEvent<HTMLInputElement>) =>
              handleMultipleImage({ e, setFieldValue })
            }
          />
        </div>
      ...
      {images.length > 0 ? (
        <div className={cx("img-wrapper")}>
          {images.map((img, index) => (
            <img src={img} key={index} height="100" width="100" />
          ))}
        </div>
      ) : null}
