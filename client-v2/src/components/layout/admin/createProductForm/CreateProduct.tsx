            ...
            <div className={cx('wrapper')}>
                <Formik
                    ...
                    onSubmit={async (values) => {
                        ...
                        try {
                            // const [singleImage, multipleImage] =
                            // await Promise.all([
                            //     adminApi.uploadSingleImage(
                            //         formDataSingleImage
                            //     ),
                            //     adminApi.uploadMultipleImages(
                            //         formDataMultipleImage
                            //     ),
                            // ]);
                ...
                >
                    {({ setFieldValue, errors, touched, isSubmitting }) => (
                        <Form encType="multipart/form-data">
                            ...
                            {image && (
                                <img src={image} height="auto" width="200" />
                            )}
