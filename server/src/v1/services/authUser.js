...
class AuthUser {
    async getUser(userEmail) {
        const sql = `SELECT * FROM ${process.env.NAME_DATABASE_V1}.users WHERE userEmail = '${userEmail}'`;
    ...
    async saveUser(userInfo) {
        ...
        const sql = `INSERT INTO ${process.env.NAME_DATABASE_V1}.users 
    ...
    async changePassword(userEmail, newPassword) {
        ...
        const sql = `UPDATE ${process.env.NAME_DATABASE_V1}.users 
