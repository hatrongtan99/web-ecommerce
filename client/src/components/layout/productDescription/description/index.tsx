  ...
  return (
    <div className={cx('description', {full: showFull})}>
      ...
      <div className={cx('img')}>
        <Image layout='fill' objectFit='contain' src='https://maydochuyendung.com/img/uploads/user_74/images/may-khoan/may-khoan-bua-milwaukee-m18-chx-502c.jpg' alt=''/>
      </div>
      ...
      <div className={cx('img')}>
        <Image layout='fill' objectFit='contain' src='https://maydochuyendung.com/img/uploads/user_74/images/may-khoan/may-khoan-bua-milwaukee-m18-chx-0x0-bare-4.jpg' alt=''/>
      </div>
      ...
      <div className={cx('img')}>
        <Image layout='fill' objectFit='contain' src='https://maydochuyendung.com/img/uploads/user_74/images/may-khoan/may-khoan-bua-milwaukee-m18-chx-0x0-bare-2.jpg' alt=''/>
      </div>
